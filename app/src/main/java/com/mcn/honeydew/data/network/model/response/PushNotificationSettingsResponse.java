...
public class PushNotificationSettingsResponse {
    ...
    @Expose
    private PushNotificationSettingsResult result;
    ...
    public PushNotificationSettingsResult getResult() {
        return result;
    }

    public void setResult(PushNotificationSettingsResult result) {
        this.result = result;
    }

    public class PushNotificationSettingsResult {
