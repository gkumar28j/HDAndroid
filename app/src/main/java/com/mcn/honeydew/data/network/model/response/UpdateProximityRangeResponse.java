...
public class UpdateProximityRangeResponse {
    ...
    @Expose
    private UpdateProximityRangeResult result;
    ...
    public UpdateProximityRangeResult getResult() {
        return result;
    }

    public void setResult(UpdateProximityRangeResult result) {
        this.result = result;
    }

    public class UpdateProximityRangeResult {
