...
public class AddItemsRecentLocationAdapter  extends RecyclerView.Adapter<AddItemsRecentLocationAdapter.ViewHolder> implements Filterable{
    ...
    public AddItemsRecentLocationAdapter() {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onItemsClicked() {
            ...
            notifyDataSetChanged();
            mCallback.onItemClick(list.get(getLayoutPosition()),getLayoutPosition());
    ...
    private class TextFilter extends Filter {
        private final AddItemsRecentLocationAdapter adapter;
        private final List<String> originalList;

        private final List<String> filteredList;

        public TextFilter(AddItemsRecentLocationAdapter adapter, ArrayList<String> parentList) {
    ...
    public interface Callback {
        ...
        void onItemClick(String data, int layoutPosition);
